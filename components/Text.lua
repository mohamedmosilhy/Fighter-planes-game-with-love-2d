...
--[[
 ...
 function Text(text, x, y, font_size, fade_in, fade_out, wrap_width, align, opacity)
    ...
    return {
        ...
        --to set the color of the text by setting the red, green, and blue components.
        setColor = function (self, red, green, blue)
            self.colors.r = red
            self.colors.g = green
            self.colors.b = blue
        end,
         -- it is the function that will draw the text on the screen and make the fade_in and fade_out
